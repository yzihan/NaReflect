    ...
    ***************************************************************************** */
    ...
    var scrollWithOptions = function (element, options, config) {
        ...
        var callback = function () {
            removeEventListener();
            var isDocument = element.nodeType === /** Node.DOCUMENT_NODE */ 9;
            element.dispatchEvent(scrollEndEvent(isDocument));
        };
        var context = __assign(__assign({}, config), { timeStamp: now(), startX: startX, startY: startY, targetX: targetX, targetY: targetY, rafId: 0, method: method, callback: callback });
